            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: Colors.white,),height: 100,
                    child: Center(
                      child: ListTile(
                        leading: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 24,
                            backgroundImage: NetworkImage(book['bookCoverUrl'] ?? ''), 
                          ),
                        ),
                        title: Text(book['title'] ?? 'Untitled',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                          ...
                          removeFav(book['id'],FirebaseAuth.instance.currentUser!.uid);
...
try {
  await FirebaseFirestore.instance.collection('favourites').doc(userId).collection('userFavourites').doc(bookid).delete();
  return true;
} catch (e) {
  print(e);
  return false;
